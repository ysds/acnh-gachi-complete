<template>
  <div class="about">
    ...
    <h2>あつ森ガチコンプについて</h2>
    <p>
      あつ森のアイテムの取得状況を管理できるウェブアプリです。来訪者やシーズンイベントなどでも絞り込むことができるため、周回にも活用いただけます。<br />
    </p>
    <p>あつ森のバージョン 2.0 に対応しています。</p>
    <h2>対象アイテム</h2>
    <p>
      あつ森のほとんどすべてのアイテムや達成状況管理ができますが、DIYでリメイクできるバリエーションはコレクション対象外としてチェック対象から外しています。ただし、お店やカタログから購入できないアイテムのバリエーションはチェック対象に含めています。
    </p>
    <p>
      DIYでリメイクできるアイテムには&nbsp;
      <img
    ...
    <h2>ログイン</h2>
    <p>
      ログインすると、データが自動的にクラウドに保存され、シェア機能が使えるようになります。複数のブラウザやデバイスでログインすることで、データを同期させることもできます。最新のデータをクラウドに保存、ダウンロードするにはページを再読み込みする必要があります。クラウドとの同期はリアルタイムで行っているわけではないため、複数のブラウザやデバイスで同時に操作すると意図通りに同期されない可能性があります。
    </p>
    <h2>シェア機能</h2>
    <svg
      ...
      class="bi bi-reply"
      viewBox="0 0 16 16"
      style="transform: scale(-1, 1); margin: -1rem 0 1rem"
    >
      <path
    ...
    />
    <p>
      アイテム画像を長押しすると、アイテムの入手方法やリメイクバリエーションなどの情報を表示できます。
    </p>
    <h2>表示モード</h2>
    ...
    <p>
      デフォルトの表示モードです。アイテムにバリエーションがある場合はそれぞれ別のタイルで表示されます。
    </p>
    <img
      class="img"
    ...
    <p>
      カイゾーにリメイクしてもらえるバリエーションを１つのタイルにまとめて表示するモードです。チェック状態はすべてのバリエーションに反映されます。
    </p>
    <img
      class="img"
    ...
    <p>
      入手方法などの情報が表示され、バリエーション毎またはバリエーション全体を一括でチェックできる表示モードです。カタログを見ながら一気にチェックする場合はこちらのモードをお勧めします。
    </p>
    <img
      class="img"
    ...
    >
      <path
        d="M2.36261 18.4448L8.01947 12.7879M8.01947 12.7879L5.42137 10.1898C4.95158 9.72001 5.06206 8.93119 5.64283 8.60854L10.6138 5.84688C10.7672 5.76168 10.8954 5.63765 10.9857 5.48722L12.3103 3.27956C12.645 2.7217 13.4148 2.62692 13.8749 3.08695L17.3669 6.57896C17.8269 7.03898 17.7321 7.80884 17.1743 8.14355L14.9966 9.45014C14.8273 9.55172 14.6919 9.70113 14.6074 9.87955L12.1625 15.041C11.8664 15.666 11.0406 15.809 10.5516 15.32L8.01947 12.7879Z"
        stroke="currentColor"
    ...
    <p>
      「来訪者・パニー島広場など」と「季節/イベント」カテゴリでは、任意のサブカテゴリをピン留めして左端に移動することができます。
    </p>
    <h2>プライバシーポリシー</h2>
    <p>
      <router-link to="/policy">プライバシーポリシーを表示する</router-link>
    </p>
    ...
    <ul class="thd-list">
      ...
      <li class="thd-list-item">
        <a
          target="_blank"
          rel="noopener"
          href="https://github.com/alexislours/acnh-strings"
          >acnh-strings</a
        >
      </li>
      <li class="thd-list-item">
    ...
    <p>
      あつ森ガチコンプのソースコードは <a target="_blank" rel="noopener" href="https://github.com/ysds/acnh-gachi-complete"
        >GitHub</a
      > で公開しています。開発にご興味のある方はぜひご参加ください。
    </p>
