<template>
  <div class="about">
    ...
    <h2>対象アイテム</h2>
    <p>
      あつ森のほとんどすべてのアイテムの管理ができます。ただし、「お店やカタログから購入可能または
      DIY
      家具」のDIYリメイクできるバリエーションはコレクション対象外としてチェック対象から外しています。
    </p>
    <p>
      DIYリメイクできるアイテムには&nbsp;
      <img
    ...
    <h2>ログイン</h2>
    <p>
      ログインすると、データが自動的にクラウドに保存され、シェア機能が使えるようになります。複数のデバイスでログインすることで、データを同期させることもできます。最新のデータをクラウドに保存、ダウンロードするにはページを再読み込みする必要があります。クラウドとの同期はリアルタイムで行っているわけではないため、複数のデバイスで同時に操作すると意図通りに同期されない可能性があります。
    </p>
    <h2>シェア機能</h2>
    <svg
    ...
    <p>
      デフォルトの表示モードです。DIYリメイクできないバリエーションを別のタイルで表示します。お店やカタログから購入できない、または
      DIY
      家具ではないアイテムのバリエーションは、DIYリメイクできる場合でも別のタイルで表示します。
    </p>
    <img
      class="img"
    ...
    <p>
      入手方法などの情報が表示され、バリエーション毎またはバリエーション全体を一括でチェックできる表示モードです。カタログを見ながらチェックするなど、一気にチェックする場合はリスト表示の方が効率的にチェックいただけます。
    </p>
    <img
      class="img"
    ...
    <h2>プライバシーポリシー</h2>
    <p><router-link to="/policy">プライバシーポリシー</router-link></p>
