<template>
  <Card title="動画を撮影してインポート">
    ...
    <p style="color: #f33">
      家具、ファッションなどの「カタログ画面」を撮影する場合、Nintendo Switch
      の本体言語を英語にすることをお勧めします。日本語のまま撮影すると動画の解析に失敗することが多いようです。
    </p>
    <div class="mb-4">
      <h5>バリエーションがあるアイテムについて</h5>
      <p>
        カタログ画面を撮影した動画から、ご自身がどのバリエーションを持っているか認識できません。そのため、バリエーションがあるアイテムはガチコンプに正確にインポートすることができません。バリエーションがあるアイテムをどのようにインポートするか設定してください。
      </p>
      <ButtonRadio
      ...
      <ButtonRadio
        ...
        >カイゾーリメイクできる場合、全バリエーションを取得済でインポートする
        <div style="font-weight: 400">
          （ファッションアイテムなど、カイゾーリメイクできないアイテムはインポートされません）
        </div></ButtonRadio
      >
    </div>
